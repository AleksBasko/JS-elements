...
$(document).ready(function(){
    ...
    let colorsArr = cols.split(")"); //gives "rgba(111,222,333,0.5" at index 0
    colorsArr = colorsArr[0].split("(");   //gives "111,222,333,0.5 at index 1
    colorsArr = colorsArr[1].split(",");
    let newCollorArr = [];
    ...
    function rgbToHsl(r, g, b){
        ...
        newCollorArr = [(h), (s*100), (l*100)];
    }
    rgbToHsl(colorsArr[0], colorsArr[1], colorsArr[2]);
    let clstr = "hsl(" + Math.floor(newCollorArr[0]) + "," + Math.floor(newCollorArr[1]) + "%," + Math.floor(newCollorArr[2] - 15) + "%)";
    console.log(clstr);
    myDiv.style.backgroundColor = clstr;
    ...
    //
    //
    //     let cols = window.getComputedStyle(myDiv, null).getPropertyValue("background-color");
    //
    //     let colorsArr = cols.split(")"); //gives "rgba(111,222,333,0.5" at index 0
    //     colorsArr = colorsArr[0].split("(");   //gives "111,222,333,0.5 at index 1
    //     colorsArr = colorsArr[1].split(",");
    ...
    //         if(i == 0) {
    //             let newCollor = colorsArr[i] * .825;
    //         }
    //         else {
    //             let newCollor = colorsArr[i] * .565;
    //         }
    //         newCollorArr.push(newCollor);
    //     }
    //
    //     myDiv.style.backgroundColor = "rgb(" + Math.floor(newCollorArr[0]) + "," + Math.floor(newCollorArr[1]) + "," + Math.floor(newCollorArr[2]) + ")";
    // });
...
function colorFunc(color, percent, dark) {
    ...
    rgbToHsl(r, g, b);
    console.log(Math.floor(newCollorArr[2] + (percent * symbol)));
